        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Message Composition</h1>
            </div>
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              <DialogTrigger asChild>
                <Button onClick={openDialog}>Compose Message</Button>
              </DialogTrigger>
              <DialogContent className="sm:max-w-[800px] max-h-[80vh] overflow-y-auto">
                          ...
                          <div key={contact.id} className="flex items-center space-x-3 p-2 hover:bg-gray-50 rounded">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="text-xs text-gray-500">
                                {contact.phoneNumber} {contact.label && `• ${contact.label}`}
                              </div>
                            </div>
                          </div>
                        ))
                ...
                <DialogFooter>
                  ...
                  >
                    {isSending ? 'Creating...' : 'Create Message'}
                  </Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
        ...
        <div className="px-4 py-6 sm:px-0">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                View your composed messages and their status
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                        ...
                        <div className="space-y-1">
                          {message.recipients.slice(0, 2).map((recipient, index) => (
                            <div key={index} className="text-sm">
                              {recipient.contact.name} ({recipient.contact.phoneNumber})
              ...
              {messages.length === 0 && (
                <div className="text-center py-8">
                  ...
                  <Button onClick={openDialog}>Create Your First Message</Button>
                </div>
              )}
            </CardContent>
          </Card>
